...
describe('P6 term guard: the blueprint abbreviation lives in README.md only', () => {
  ...
  it('scans the published tree (source, tests, tools, public docs, notices)', () => {
    for (const f of ['packages/core/src/index.ts', 'apps/web/src/App.tsx', 'apps/server/src/storage.ts', 'tools/licenses/asset_inventory.py', 'docs/PLAN.md', 'docs/DECISIONS-v2-2.md', 'NOTICE', 'TRADEMARKS.md']) {
